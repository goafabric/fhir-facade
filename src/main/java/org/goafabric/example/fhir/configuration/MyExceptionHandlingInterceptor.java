...
@Interceptor
public class MyExceptionHandlingInterceptor {

    public static final String PROCESSING = Constants.OO_INFOSTATUS_PROCESSING;
    private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(MyExceptionHandlingInterceptor.class);
     ...
     */
    public MyExceptionHandlingInterceptor setReturnStackTracesForExceptionTypes(Class<?>... theExceptionTypes) {
